...
ecmd_ifdef(MATEMAT_SUPPORT)
    ecmd_feature(matemat_settemp,"matemat set temp")
    ecmd_feature(matemat_gettemp,"matemat get temp")
    ecmd_feature(matemat_cooling,"matemat cooling")
ecmd_endif()
